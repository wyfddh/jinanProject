    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'endSignTime', title:'报名截止时间', width: 140, sort: true, templet: function (row) {
                        return formatDate(row.endSignTime);
                    }}
                ,{field:'startTime', title:'开始时间', width: 140, sort: true, templet: function (row) {
                        return formatDate(row.startTime);
                    }}
                ,{field:'endTime', title:'结束时间', width: 140, sort: true, templet: function (row) {
                        return formatDate(row.endTime);
                    }}
                ,{field:'needNumber', title:'需求人数', width: 90, edit: 'text'}
                ,{field:'applyCount', title:'申请人数', width: 90, edit: 'text'}
