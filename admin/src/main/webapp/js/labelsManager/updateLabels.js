        ...
        }else
        {
            ...
            layui.use('form', function(){
                ...
                $.ajax({
                    ...
                    data:json,
                    async:false,
                    url:property.getProjectPath()+"labelManager/queryLabelById.do",
...
//监听提交
            form.on("submit(save)", function (data) {
                ...
                $.ajax({
                    type:"post",
                    data: formData,
                    url:projectName + 'labelManager/updatelabel.do',
                    success:function(result) {
          ...
          /*  //监听提交
            form.on('submit(save)', function(data){
                ...
                alert(postVideo);
                var url = "labelManager/updatelabel.do";
...
*!/
              /!* $.ajax({
                    ...
                    success:function(result) {
                        if (result.success == 1) {
                            top.layer.msg("保存成功");
                            parent.$t.goback("page/labelManager/labelsList.html");
                        } else {
                            top.layer.msg(result.error.message);
                        }
                    },
...
function setFormData(data) {
    ...
    $("#createDate").val(formatSimpleDate(data.createDate))
