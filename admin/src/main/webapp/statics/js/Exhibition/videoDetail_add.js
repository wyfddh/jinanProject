    ...
    initTable: function () {
        ...
        layui.use('form', function () {
            ...
            form.on('submit(formDemo)', function (data) {
                ...
                var exhibitionDto = {exhibition: '', listExhibRoom: [], listExhibCollection: choseCollect, listExhibVideo: choseVideo};
                exhibitionDto.exhibition = data.field;
                exhibitionDto.listExhibRoom = dataRoom.map((obj) => {return {roomName: obj.inputRoomName, roomTitle: obj.inputRoomTitle}});
                var datas = yc.ajaxPostByJson('exhib/addExhibition', exhibitionDto, null, '新增成功');
        ...
        layui.use(['upload', 'element','form'], function () {
            ...
            var demoListView = $('#demoList')
                ...
                elem: '#test10'
                ,url: property.getProjectPath()+"attach/upload.do?tableName="+"exhibition"
                , accept: 'file'
                , multiple: true
                , auto: false
                , xhr: xhrOnProgress
        ...
        $("#roomAddId").click(function () {
            ...
            var datas = {id: dataRoom.length, inputRoomName: inputRoomName, inputRoomTitle: inputRoomTitle};
            dataRoom.push(datas);
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {field: 'saveType', title: '类型', templet: function (data) {
                            ...
                            for (var i = 0, length = videoSaveTypeList.length; i < length; i++) {
                    ...
                    , {field: 'relativeCollectionName', title: '关联藏品', templet: function (res) {
