...
function loadCount() {
    $.ajax({
        type:"get",
        async:false,
        url:property.getProjectPath()+"PostVideo/getVideoCjCount.do",
    ...
    $.ajax({
        type:"get",
        async:false,
        url:property.getProjectPath()+"PostVideo/getVideoCxCount.do",
        success:function(result) {
            if (result.success == 1) {
                var data = result.data;
...
function loadTask() {
    ...
    $.ajax({
        ...
        type:"post",
        async:false,
        url:property.getProjectPath()+"PostVideo/getUndoTask.do",
        success:function(result) {
            if (result.success == 1) {
                var data = result.data;
                undoTask = data;
    ...
    $.ajax({
        ...
        type:"post",
        async:false,
        url:property.getProjectPath()+"PostVideo/getDoneTask.do",
        success:function(result) {
            if (result.success == 1) {
                var data = result.data;
                doneTask = data;
    ...
    $.ajax({
        ...
        type:"post",
        async:false,
        url:property.getProjectPath()+"PostVideo/getFinishTask.do",
        success:function(result) {
            if (result.success == 1) {
                var data = result.data;
                finishTask = data;
...
function loadNotice() {
    var json = {"userId":userInfo.userId,"status":0,"type":"1"};
    $.ajax({
        data:json,
        type:"post",
        async:false,
...
function showTask(processInstId) {
    ...
    $.ajax({
        ...
        type:"post",
        async:false,
        url:property.getProjectPath()+"PostVideo/getWfAction.do",
        success:function(result) {
            if (result.success == 1) {
                var data = result.data;
...
function goPage(type,id,processInstId,status) {
    ...
    //上传审批
    if (type == '1'){
        parent.$t.goToPageSimple("page/video/videoShow.html","查看","page/main/main.html");
    }
    //查询审批
    else if(type == '2'){
...
function getShortcutEntrance() {
    ...
    var json = {"currentUserId":userInfo.userId,"currentId":currentId,"type":"1"};
    $.ajax({
        data:json,
        type:"post",
        async:false,
        ...
        success:function(result) {
            if (result.success == 1) {
                ...
                $(".shortcut").click(function () {
                   ...
                   parent.$t.goToPageSimple(dataUrl,name,"page/main/main.html");
                })
            } else {
                top.layer.msg(result.error.message);
            }
...
function setShortcutEntrance() {
    layui.use('form', function() {
        ...
        layer.confirm('', {
                ...
                var json = {"currentUserId": userInfo.userId, "shortcutEntrance": authSetting,"type":"1"};
                $.ajax({
...
function showNotice(id) {
    ...
    $.ajax({
        ...
        type:"post",
        async:false,
        url:property.getProjectPath()+"PostVideo/getWfActionByNotice.do",
        success:function(result) {
            if (result.success == 1) {
                var data = result.data;
                updateNotice(id);
