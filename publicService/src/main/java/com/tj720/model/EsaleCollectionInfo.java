 ...
 * @author 
 */
public class EsaleCollectionInfo implements Serializable {
    /**
     * 主键
     */
    private String id;
    ...
    private String hotRecommendCheck;

    public String getHotRecommendCheck() {
        return hotRecommendCheck;
    }

    public void setHotRecommendCheck(String hotRecommendCheck) {
        this.hotRecommendCheck = hotRecommendCheck;
    }
}