...
public class JsonResult implements Serializable {
	...
	public String getJsonpString(String jsonp){
//		JSONObject object = (JSONObject) JSONObject.toJSON(this);
		String result = jsonp + "(" + JSONObject.toJSONString(this, WriteMapNullValue, WriteNullStringAsEmpty, WriteNullNumberAsZero) + ")";
		return result;
	}
}
