    ...
    initTable: function () {
        ...
        layui.use('form', function () {
            ...
            form.on('submit(formDemo)', function (data) {
                ...
                yc.ajaxPostByJson('exhib/updateExhibition', exhibitionDto, null, '修改成功');
        ...
        $("#roomAddId").click(function () {
            ...
            if (yc.isNull(inputRoomName)) {
                ...
                var datas = {id: listExhibRoom.length, roomName: inputRoomName, roomTitle: inputRoomTitle};
