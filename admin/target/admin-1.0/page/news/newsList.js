        ...
        var index = layui.layer.open({
            ...
            success : function(layero, index){
                ...
                if(edit){
                    ...
                    body.find("#news_content1").val(edit.content);
                    body.find("#news_content2").val(edit.content);
                    body.find("#news_content3").val(edit.content);
                    body.find("#news_content4").val(edit.content);
