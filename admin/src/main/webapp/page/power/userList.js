    ...
    var tableIns = table.render({
      ...
      loading:false,
        ...
        cols : [[
            ...
            {field: 'userEmail', title: '所属组织', minWidth:200, align:'center'/*,templet:function(d){
                return '<a class="layui-blue" href="mailto:'+d.userEmail+'">'+d.userEmail+'</a>';
            }*/},
            {field: 'number', title: '登陆手机号', align:'center',minWidth:100},
            {field: 'type', title: '账户类型', align:'center',minWidth:100},
            {field: 'role', title: '角色', align:'center',minWidth:100},
            {field: 'userEndTime', title: '添加时间', align:'center',minWidth:150},
            {field: 'key', title: '状态', align:'center',minWidth:150},
