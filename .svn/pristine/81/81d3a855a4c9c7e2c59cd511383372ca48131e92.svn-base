...
var main={
        ...
        layui.use(['form','table'], function(){
            ...
            table.on('tool(test)', function(obj){
                ...
                if(obj.event === 'detail'){
                    ...
                    parent.$t.goToPage(this,"page/video/videoBatchApproval.html");
                }
    ...
    tabBind:function () {
        ...
        $("#save").on('click', function(data){
            ...
            var url = 'PostVideo/batchApprovalProcess.do';
            ...
            for (var i=0;i<videoData.length;i++){
                ids.push(videoData[i]["partyId"]);
            }
            var json = {"actionType":actionType,"approval":approval,"ids":ids,"remark":remark,"authSetting":authSetting,"currentUserId":userInfo.userId};
            $.ajax({
